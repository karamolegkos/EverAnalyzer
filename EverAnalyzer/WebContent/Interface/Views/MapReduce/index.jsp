...
<meta charset="ISO-8859-1">
	<title>EverAnalyzer - Processing</title>
    ...
    <div class="main">
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color: lightgray;">
          <div class="container">
            ...
            <p class="lead">
            	Process data using EverAnalyzer.
            </p>
          </div>
        </div>
        ...
        <div class="container border border-dark">
            ...
            <div class="container" style="font-size: medium;">
            	<div class="alert alert-warning" role="alert" id="noPreprocessesWarning" style = "display:none; margin-top: 12px;">
				  To use Processing, you need to pre-process data in the <u>"Pre-processing"</u> tab.<br>
				  You need to have Pre-processed Data to Process them.
				</div>
            </div>
